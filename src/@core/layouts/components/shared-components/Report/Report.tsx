import { Button, Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions, Box, TextField, Grid, Avatar, Paper, Typography, CircularProgress, IconButton } from '@mui/material'
...
const Report = (props: ReportProps) => {
 ...
 console.log('commentIdData',commentIdData)
  ...
  useEffect(() => {
    ...
    if (type === 'Post') {
      setIdReport(postDetails.data.post._id);
    }
          ...
          <Box>
            <Box sx={{ width: '100%' }}>
              ...
              <Box>
                ...
                {(postDetails.data.post.images[0].includes("/images") ? (
                  <img style={{ maxWidth: '100%', maxHeight: '100%' }} src={postDetails.data.post.images[0]} alt='image' />
                ) : postDetails.data.post.images[0].includes("/videos") ? (
                  <video autoPlay controls muted loop style={{ width: '100%', height: '100%' }}>
                    <source src={postDetails.data.post.images[0]} />
                  </video>
                ) : null)}
                {/* <img
              width={'100%'}
              ...
              src={postDetails.data.post.images[0]}
              loading="lazy"
            /> */}
            ...
            <form autoComplete="off" onSubmit={handleSubmit} >
              ...
              {type === 'Post' ? (
                <Button variant="outlined" color="error" type="submit" >Report Post</Button>
              ) : type === 'User' ? (
